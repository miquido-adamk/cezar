...
export function ProjectGroups({
  ...
  /** `capabilities.loops` — opt-in task loops (spec `2026-08-19-task-loops`). Workspace-level,
   *  not per-project: the flag is one server's answer for every project it serves. */
